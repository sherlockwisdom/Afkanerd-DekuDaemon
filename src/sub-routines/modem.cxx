...
bool Modem::mmcli_send_sms( string message, string number ) {
	...
	string sms_results = sys_calls::terminal_stdout(this->configs["DIR_SCRIPTS"] + "/modem_information_extraction.sh sms send \"" + helpers::remove_char_advanced(message, '\'') + "\" " + number + " " + this->getIndex());
