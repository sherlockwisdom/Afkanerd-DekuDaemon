...
int main() {
	...
	vector<string> in_delimeter_expected_comma_sample = {"message=Hello world\"this is a sample message"};
	vector<string> in_delimeter_expected_equal_sample = {"00000,message"};
	...
	vector<string> parser_sample31 = parsers::in_delimeter_extract( sample, '=');
	...
	if( in_delimeter_expected_comma_sample == parser_sample3 ) {
		cout << __FUNCTION__ << ": comma PASSED" << endl;
	}
	else {
		cout << __FUNCTION__ << ": comma FAILED" << endl;
	...
	if( in_delimeter_expected_equal_sample == parser_sample31 ) {
		...
		cout << __FUNCTION__ << ": equal FAILED" << endl;
		for(auto i : parser_sample31 ) cout << i << ", ";
	}
	return 0;
}
